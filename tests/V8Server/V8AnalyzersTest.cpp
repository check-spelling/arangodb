...
#include "src/api/api.h"  // must include V8 _before_ "catch.cpp' or CATCH() macro will be broken
// #include "src/objects-inl.h"  // (required to avoid compile warnings) must
// include V8 _before_ "catch.cpp' or CATCH() macro will be broken
#include "src/objects/scope-info.h"  // must include V8 _before_ "catch.cpp' or CATCH() macro will be broken
