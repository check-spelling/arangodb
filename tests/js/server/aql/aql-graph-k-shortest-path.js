      ...
      switch (step) {
        case 0: {
          if (pathNum < 6) {
            ...
            if (pathNum < 3) {
              // Add INBOUND shortcut 0 <- 2 in e2 (we intentionally go to path 6-8 to not interfere with the original paths)
        ...
        case 2: {
          if (pathNum < 3) {
            ...
            if (pathNum === 1) {
              ...
              // Add an additional step only on the second path to have different path lengths
