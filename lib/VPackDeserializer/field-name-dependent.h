...
struct field_name_dependent {
  using constructed_type =
      std::variant<typename NDs::deserializer::constructed_type...>;
};
...
template<typename R, const char N[], typename D, const char... Ns[],
         typename... Ds>
struct field_name_dependent_executor<R, field_name_deserializer_pair<N, D>,
                                     field_name_deserializer_pair<Ns, Ds>...> {
  ...
  static auto unpack(::arangodb::velocypack::deserializer::slice_type s,
    ...
    if (!keySlice.isNone()) {
      ...
      return deserialize<D, hints, C>(s, std::make_tuple(keySlice),
                                      std::forward<C>(ctx))
    ...
    return field_name_dependent_executor<
        R, field_name_deserializer_pair<Ns, Ds>...>::unpack(s,
                                                            std::forward<C>(
                                                                ctx));
  }
};
...
struct deserialize_plan_executor<field_name_dependent<NDs...>, H> {
  ...
  using variant_type =
      typename plan_result_tuple<field_name_dependent<NDs...>>::variant;
  ...
  static auto unpack(::arangodb::velocypack::deserializer::slice_type s,
    ...
    return ::arangodb::velocypack::deserializer::detail::
        field_name_dependent_executor<variant_type, NDs...>::unpack(
               s, std::forward<C>(ctx))
            .visit(
